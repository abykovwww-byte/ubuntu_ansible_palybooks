        ...
        *,
        ...
        messages = _structured_messages(
            system=(
                ...
                "Различай говорящего и адресата: имя в обращении относится к адресату, "
                "не к говорящему; второе лицо в повествовании обозначает игрока. "
                "Не выводи природу, способности или принадлежность наблюдателя из того, "
                "что он заметил событие. При неясном участнике не создавай факт о личности. "
                "Сравнение и предположение не являются событием: не превращай образную "
                "реакцию в приказ или воздействие. Совпадение по времени не доказывает причину. "
        ...
        *,
        ...
        messages = _structured_messages(
            system=(
                ...
                "каждый тезис должен прямо подтверждаться выбранными spans. "
                "Различай говорящего и адресата: имя в обращении относится к адресату, "
                "не к говорящему; второе лицо в повествовании обозначает игрока. "
                "При неясном участнике не создавай факт о личности. Сравнение и "
                "предположение не являются событием: не превращай образную реакцию "
                "в приказ или воздействие. Совпадение по времени не доказывает причину. Корень "
