...
Links are sparse authored events, not a default feature of corporate messages. Only turns 4, 6 and 9 may contain a URL and only the fixed URL supplied by `TRAINING_ARTIFACT_CONTRACT`. On turns 1, 2, 3, 5, 7, 8 and 10 write exactly `Ссылки: нет` and do not place any URL elsewhere in the response.
