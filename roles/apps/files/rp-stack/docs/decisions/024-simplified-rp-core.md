...
персонажа игрока. Явное `я` вне прямой речи, first-person attribution после
реплики (`— ..., — отвечаю ...`) или устойчивые безличные player-action starts
запускают существующий единственный repair. Прямая речь NPC от первого лица
остаётся допустимой. Если repair снова играет за персонажа игрока, state и turn
не коммитятся.
