...
- [Decision 018: standalone Training/Showroom boundary](../../roles/apps/files/rp-stack/docs/decisions/018-separate-training-and-rp-gateways.md)
- [Plan 018: standalone cutover](../../roles/apps/files/rp-stack/docs/plans/018-awareness-showroom-project-split.md)
