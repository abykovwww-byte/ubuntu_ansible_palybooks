...
Эта Wiki описывает фактический `main` репозитория на 31 июля 2026 года. Исходный код, решения и конфигурация проверялись на ревизии `2eb7bbd`; сама Wiki версионируется вместе с репозиторием.
...
- интерактивные фишинговые мини-сайты в Showroom — архитектурная концепция проработана, но runtime ещё не реализован;
