...
Эта Wiki описывает фактический `main` репозитория на 31 июля 2026 года. Код и документация интерактивных training artifacts актуализированы одним изменением; точная revision видна в истории Git.
